...
class Qualification
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Salarie::class, mappedBy: 'IdQualification')]
    ...
    public function addSalary(Salarie $salary): static
    {
        if (!$this->salaries->contains($salary)) {
            ...
            $salary->setIdQualification($this);
        }
    ...
    public function removeSalary(Salarie $salary): static
    {
        if ($this->salaries->removeElement($salary)) {
            ...
            if ($salary->getIdQualification() === $this) {
                $salary->setIdQualification(null);
            }
        }
