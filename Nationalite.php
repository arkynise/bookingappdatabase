...
class Nationalite
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Salarie::class, mappedBy: 'IdNationalite')]
    ...
    public function removeSalary(Salarie $salary): static
    {
        if ($this->salaries->removeElement($salary)) {
            ...
            if ($salary->getIdNationalite() === $this) {
                $salary->setIdNationalite(null);
            }
        }
